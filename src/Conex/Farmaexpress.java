...
public class Farmaexpress {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			Class.forName(JDBC_DRIVER);
                        conn = DriverManager.getConnection("jdbc:mysql://35.185.90.173:3306/FARMAEXPRESS?user=estudiante" ,USER ,PASS);
                        stmt = conn.createStatement();
			//Create tables
			...
			String createAddress ="create table DIRECCION" + "(id_direccion int NOT NULL, " +
					...
					"calle_principal varchar(50) NOT NULL, " + "calle_secundaria varchar(50) NOT NULL, " +
			...
			String createMedicine ="create table MEDICAMENTO " + "(serie varchar(20) NOT NULL, " +
			...
			String createHistory_Detail ="create table DETALLE_HISTORIAL " + "(id_detalle_historial int NOT NULL, " +
					"serie varchar(20) NOT NULL, " +
					"PRIMARY KEY (id_detalle_historial), " +
					"FOREIGN KEY (serie) REFERENCES MEDICAMENTO (serie))";
			...
			String createRecord ="create table HISTORIAL " + "(id_historial int NOT NULL, " +
					...
					"FOREIGN KEY (serie) REFERENCES MEDICAMENTO (serie), " +
					"FOREIGN KEY (id_detalle_historial) REFERENCES DETALLE_HISTORIAL (id_detalle_historial))";
